...
@org.kie.api.definition.type.Label("AccountMetadata")
public class AccountMetadata implements java.io.Serializable
{

   static final long serialVersionUID = 1L;

   @org.kie.api.definition.type.Label("public_alias")
   private java.lang.String public_alias;
   @org.kie.api.definition.type.Label("private_alias")
   private java.lang.String private_alias;
   @org.kie.api.definition.type.Label("more_info")
   private java.lang.String more_info;
   @org.kie.api.definition.type.Label("image_URL")
   private java.lang.String image_URL;
   @org.kie.api.definition.type.Label("open_corporates_URL")
   private java.lang.String open_corporates_URL;
   @org.kie.api.definition.type.Label("corporate_location")
   private com.panorama.disputes.Location corporate_location;
   @org.kie.api.definition.type.Label("physical_location")
   private com.panorama.disputes.Location physical_location;
   ...
   public com.panorama.disputes.Location getCorporate_location()
   {
      return this.corporate_location;
   }

   public void setCorporate_location(
         com.panorama.disputes.Location corporate_location)
   {
      this.corporate_location = corporate_location;
   }

   public com.panorama.disputes.Location getPhysical_location()
   {
      return this.physical_location;
   }

   public void setPhysical_location(
         com.panorama.disputes.Location physical_location)
   {
